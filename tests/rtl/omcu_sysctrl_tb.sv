...
module omcu_sysctrl_tb;
  ...
  initial begin
    ...
    check_read(32'h0000_0004, 32'h0000_0003, "ABI version must encode v0.3");
    check_read(32'h0000_0008, 32'h0000_007f, "feature bits must describe implemented v1 digital peripherals");
