[CmdletBinding()]
param(
    [ValidateSet('timer', 'gpio', 'uart', 'uart1', 'spi', 'i2c', 'wdt', 'pwm', 'irqctrl', 'sysctrl', 'pinmux', 'user-flash', 'system', 'system-uart', 'sdk-isa', 'sdk-peripherals', 'sdk-i2c', 'sdk-irq', 'tn9k-wdt', 'tn9k-peripherals', 'tn9k', 'mcu-top')]
    [string]$Test = 'timer'
)
